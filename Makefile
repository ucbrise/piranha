...
CXX=/usr/local/cuda-11.5/binnvcc
...
terminal: piranha.out
	./piranha.out 2 files/IP_$(RUN_TYPE) files/keyC files/keyAC files/keyBC >/dev/null 2>&1 &
	./piranha.out 1 files/IP_$(RUN_TYPE) files/keyB files/keyBC files/keyAB >/dev/null 2>&1 &
	./piranha.out 0 files/IP_$(RUN_TYPE) files/keyA files/keyAB files/keyAC
